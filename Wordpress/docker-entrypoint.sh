...
# - run as non root (www-data for apache)
# - bootstrap the config from envvars to wp-config.php



#https://github.com/docker-library/redmine/blob/master/docker-entrypoint.sh
